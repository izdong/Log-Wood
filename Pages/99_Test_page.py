...
#             overall.update_layout(bargap = 0.15, height=250)
#             st.plotly_chart(overall, use_container_width=True,height=250)

#         with tab2:
#             month = px.histogram(sort_date, x = 'month', text_auto = True)
#             month.update_layout(bargap=0.2, height=250)
#             st.plotly_chart(month, use_container_width=True,height=250)

#         with tab3:
#             dow = px.histogram(df, x="day", category_orders=dict(day=["Mon", "Tue", "Wed", "Thu", "Fri", "Sat"]), text_auto = True)
#             dow.update_layout(height=250) 
#             st.plotly_chart(dow, use_container_width=True,height=250)
...
#             Type.update_layout(height=250)
#             st.plotly_chart(Type, use_container_width=True,height=250)
...
#             st.plotly_chart(Type, use_container_width=True,height=250)
 ...
 # _________________________________________________________________________________OLD OVERVIEW_________________________________________________________________________________
import numpy as np
import streamlit as st
import pandas as pd
from streamlit_option_menu import option_menu
